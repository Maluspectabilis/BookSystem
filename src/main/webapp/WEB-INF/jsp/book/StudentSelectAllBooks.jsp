              ...
              <table class="result-tab" width="60%" border="1">
                ...
                <c:forEach var="book" items="${books}" >
                  <tr>
                    ...
                    <td align="center">
                      <a href="${pageContext.request.contextPath}/Book/borrowBook2?bookName=${book.bookName}&bookPrice=${book.bookPrice}&author=${book.author}&number=${book.number}&name=${name}&account=${account}">借书</a>
