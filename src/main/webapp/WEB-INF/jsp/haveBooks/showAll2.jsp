                            ...
                            <table class="result-tab" width="60%" border="1">
                                ...
                                <c:forEach var="book" items="${haveBooks}" >
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="${pageContext.request.contextPath}/HaveBooks/returnBook2?bookName=${book.bookName}&bookPrice=${book.bookPrice}&author=${book.author}&number=${book.number}&time=${book.time}&name=${name}&account=${account}">还书</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
