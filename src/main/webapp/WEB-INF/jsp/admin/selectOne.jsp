    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item" style="background-color: #16baaa;"><a href="${pageContext.request.contextPath}/Admin/AdminShowOneInit?name=${name}&account=${account}">查询单个学生/图书信息</a></li>
    ...
    <div class="layui-body" style="background-color: #f2f2f2;">
        ...
        <div style="padding: 15px;">
            ...
            <div class="container">
                ...
                <!-- 表单 -->
                <form id="myform" name="" method="post" action="${pageContext.request.contextPath}/Admin/AdminShowOne?name=${name}&account=${account}">
                    <div class="form-container">
                        <label for="bookName">学生账号：</label>
                        <input type="text" id="bookName1" name="account1">
                ...
                <div class="result-content">
                    <table id="book-table1" class="table table-bordered table-hover">
                        <thead>
                        <tr>
            ...
            <div class="container">
                ...
                <!-- 表单 -->
                <form id="myform2" name="" method="post" action="${pageContext.request.contextPath}/Admin/AdminShowOne2?name=${name}&account=${account}">
                    <div class="form-container">
                    ...
                    <table id="book-table" class="table table-bordered table-hover">
                        ...
                        <c:if test="${not empty book}">
                            <tr>
                                ...
                                <td align="center">
                                    <a href="${pageContext.request.contextPath}/Book/borrowBook4?bookName=${book.bookName}&bookPrice=${book.bookPrice}&author=${book.author}&number=${book.number}&name=${name}&account=${account}">借书</a>
