...
<body>
<form action="${pageContext.request.contextPath}/System/adminLogin" method="post">
    <div>${msg}</div>
    账号：<input type="text" name="account"/><br/>
    密&nbsp;&nbsp;码：
    <input type="password" name="password" /><br/>
    <input type="submit" value="登录"/>
    <a href="${pageContext.request.contextPath}/System/adminRegisterInit">注册</a>
...
<div class="main">
    ...
    <form class="layui-form" action="${pageContext.request.contextPath}/System/adminLogin" method="post">
...
<%--            </div>--%>
    ...
    <%--        </div>--%>
            ...
            <div class="layui-form-item demo-login-other" style=";align-content: center">
    <%--            <span style="padding: 0 21px 0 6px;">--%>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/System/adminRegisterInit" style="color: #16baaa;align-content: center" id="ww">管理注册帐号</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/System/studentLoginInit" style="color: #16baaa;align-content: center" id="ww">学生端登录/注册</a>
                <%--            </span>--%>
