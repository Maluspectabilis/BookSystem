    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item" style="background-color: #16baaa;"><a href="${pageContext.request.contextPath}/HaveBooks/showAll2?name=${name}&account=${account}">还书</a></li>
            </ul>
        </div>
    </div>
    <div class="layui-body" style="background-color: #f2f2f2;">
        ...
        <div style="padding: 15px;">
            ...
            <div class="layui-card layui-panel">
                ...
                <a href="${pageContext.request.contextPath}/HaveBooks/showAll2?name=${name}&account=${account}" class="center-link"
