...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <li class="layui-nav-item layui-hide-xs"><a href="javascript:;">输入书本成功</a></li>
    ...
    <div class="layui-body" style="background-color: #f2f2f2;">
        ...
        <div style="padding: 15px;">
            ...
            <div class="layui-card layui-panel">
                ...
                <p style="text-align: center; font-weight: bold; font-size: 50px;">&nbsp;&nbsp;输入书本成功！</p>

                <br>
                <br>
                <br>

                <a href="${pageContext.request.contextPath}/Book/addBookInit?name=${name}&account=${account}" class="center-link"
