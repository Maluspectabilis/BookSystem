    ...
    <div class="layui-body" style="background-color: #f2f2f2;">
        ...
        <div style="padding: 15px;">
            ...
            <div class="layui-card layui-panel">
                ...
                <p style="text-align: center; font-weight: bold; font-size: 50px;">${msg}</p>

                <br>
                <br>
                <br>

                <a href="${pageContext.request.contextPath}/Student/addStudentInit?name=${name}&account=${account}" class="center-link"
