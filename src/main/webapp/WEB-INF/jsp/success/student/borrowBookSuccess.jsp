...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <li class="layui-nav-item layui-hide-xs"><a href="javascript:;">借书成功</a></li>
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item" style="background-color: #16baaa;"><a href="${pageContext.request.contextPath}/Book/StudentSelectAllBooks?name=${name}&account=${account}">查询所有书本信息/借书</a></li>
    ...
    <div class="layui-body" style="background-color: #f2f2f2;">
        ...
        <div style="padding: 15px;">
            ...
            <div class="layui-card layui-panel">
                ...
                <p style="text-align: center; font-weight: bold; font-size: 50px;">借书成功！</p>

                <br>
                <br>
                <br>

                <a href="${pageContext.request.contextPath}/Book/StudentSelectAllBooks?name=${name}&account=${account}" class="center-link"
